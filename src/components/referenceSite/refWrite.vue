  ...
  <b-container fluid>
    ...
    <div class="container">
      <div>
        ...
        <div class="info">
          * 참고 사이트 등록은 관리자 승인 후 업로드 됩니다. (작성일 기준 1-2일
          소요)
        </div>
        <hr />
        ...
        <b-form
          role="form"
          @submit.prevent="enrollref"
          @reset="onReset"
          enctype="multipart/form-data"
        >
          <b-form-group label="사이트명">
            <b-form-input
              v-model="reftitle"
              type="text"
              required
          ...
          <b-form-group label="분류" label-for="input-3">
            <b-form-select
              v-model="category"
              :options="refcategory"
              required
          ...
          <!-- 등록버튼  -->
          <div class="btn_sr2">
            <b-button type="submit" id="btn_write2" class="btn-space2"
              >등록하기</b-button
            >
            <b-button
              type="button"
