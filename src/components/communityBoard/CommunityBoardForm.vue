<template>
  <b-container>
    <div class="container" id="header-container">
      ...
      <b-button type="button" id="list-btn2" to="/communityBoardList" exact
        >목록</b-button
      >
    </div>
  ...
  methods: {
    enrollBoard() {
      setTimeout(() => {
        ...
        axios
          .post(
            "http://rclass.iptime.org:9999/20AM_ITJOBGO_BOOT_FINAL/community/communityBoardForm",
            formData,
            {
              headers: {
