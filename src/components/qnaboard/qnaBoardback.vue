        ...
        <v-card-title>
          ...
          <template v-slot:item="props">
                <tr @click="handleClick(props.item.qboardNo)">
                  ...
                  <td v-if="props.item.qnaCategory.includes('백엔드')" class="text-xs-right">{{props.item.qnaTitle }}
                    <v-icon v-if="props.item.commentCount >0">mdi-message-text</v-icon>
                  </td>
                  <td v-if="props.item.qnaAnswerYn==='N' && props.item.qnaCategory.includes('백엔드')" class="text-xs-right">
                    <v-btn class="mx-2 answerbtn1" dark small>답변대기</v-btn>
                      </td>
                  <td v-else-if="props.item.qnaAnswerYn==='Y' && props.item.qnaCategory.includes('백엔드')" class="text-xs-right">
