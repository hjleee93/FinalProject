      ...
      <div class="row">
        ...
        <div class="container">
          ...
          <div align="right">
              ...
              to="/communityBoardForm" exact>글쓰기</b-button>
          </div>  
  ...
  export default {
    data() {
      return {
        ...
        currentPage: 1,
        items: [
          {분류: '질문', 내용: '백앤드개발자 업무가 궁금합니다', 작성자 : '김주은',작성일: '2020/10/09' },
          {분류: '추천', 내용: '인프런 강의 좋네요', 작성자 : '김민지',작성일: '2020/10/09' },
          {분류: '일반', 내용: '개발자 가이드', 작성자 : '김현주',작성일: '2020/10/09' },
          {분류: '질문', 내용: '백앤드개발자 업무가 궁금합니다', 작성자 : '김주은',작성일: '2020/10/09' },
          {분류: '추천', 내용: '인프런 강의 좋네요', 작성자 : '김민지',작성일: '2020/10/09' },
          {분류: '일반', 내용: '개발자 가이드', 작성자 : '김현주',작성일: '2020/10/09' },
