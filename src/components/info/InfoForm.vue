<template>
  <b-container>
    <div class="container">
      <h2 class="st_title">Information 작성</h2>
      <hr />

      <!--     <b-form role="form" @submit.prevent="enrollInfo" 
    @reset="onReset"  enctype="multipart/form-data"> -->
      <b-form @submit.prevent="enrollInfo" enctype="multipart/form-data">
...
export default {
  ...
  methods: {
    enrollInfo() {
      ...
      axios
        .post(
          "http://rclass.iptime.org:9999/20AM_ITJOBGO_BOOT_FINAL/info/infoForm",
          formData,
          {
            headers: {
