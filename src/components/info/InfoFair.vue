...
<v-tabs
  ...
  <v-card-title class="search-bar">
    ...
    <template v-slot:item="props">
        ...
        <td v-if="props.item.infoCategory.includes('박람회')" class="text-xs-right">{{props.item.infoSq }}</td>
        <td v-if="props.item.infoCategory.includes('박람회')" class="text-xs-right">{{props.item.infoTitle }}</td>
        <td v-if="props.item.infoCategory.includes('박람회')" class="text-xs-right">{{props.item.infoDate }}</td>
        <td v-if="props.item.infoCategory.includes('박람회')" class="text-xs-right">{{props.item.infoTime }}</td>
        <td v-if="props.item.infoCategory.includes('박람회')" class="text-xs-right">{{props.item.infoContent }}</td>
        <td v-if="props.item.infoCategory.includes('박람회')" class="text-xs-right">{{props.item.infoCount }}</td>
        </tr>
    </template>  
    </v-data-table>
  </v-card>
