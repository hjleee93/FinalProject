              ...
              <tr>
                ...
                <td>
                  <input
                    ...
                    id="schoolName1"
                    v-model="schoolName1"
                    :placeholder="resume.schoolName1"
                  />
                </td>
                <td>
                  <input
              ...
              <tr>
                ...
                <td>
                  <input
                    ...
                    id="schoolName2"
                    v-model="schoolName2"
                    :placeholder="resume.schoolName2"
                  />
                </td>
                <td>
                  <input
              ...
              <tr>
                ...
                <td>
                  <input
                    ...
                    :placeholder="resume.licenseAgency"
                  />
                </td>
                <td>
              ...
              <tr>
                ...
                <td>
                  <input
                    ...
                    :placeholder="resume.languageLevel"
                  />
                </td>
                <td>
                  <input
                ...
                <td>
                  <input
                    ...
                    :placeholder="resume.languageScore"
                  />
                </td>
                <td>
              ...
              <tr>
                ...
                <td>
                  <input
                    ...
                    :placeholder="resume.activityAgency"
                  />
                </td>
                <td>
                  <input
                    ...
                    :placeholder="resume.activityWork"
                  />
                </td>
              </tr>
              <tr>
                ...
                <td colspan="4">
                  <b-form-textarea
                    ...
                    :placeholder="resume.activityDetail"
                  ></b-form-textarea>
                </td>
              </tr>
            </table>
              ...
              <tr>
                ...
                <td colspan="4">
                  <b-form-textarea
                    ...
                    :placeholder="resume.projectDetail"
                  ></b-form-textarea>
                </td>
              </tr>
            </table>
              ...
              <tr>
                ...
                <td>
                  <input
                    ...
                    :placeholder="resume.abroadCountury"
                  />
                </td>
                <td>
                  <input
              ...
              <tr>
                ...
                <td colspan="4">
                  <b-form-textarea
                    ...
                    :placeholder="resume.abroadDetail"
                  ></b-form-textarea>
                </td>
              </tr>
            </table>
...
export default {
  ...
  methods: {
    ...
    updateResume() {
      ...
      axios
        .post(
          "http://rclass.iptime.org:9999/20AM_ITJOBGO_BOOT_FINAL/itjobgo/resume/updateResume.do",
          formData,
          {
            headers: {
