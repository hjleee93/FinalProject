  ...
  <div class="Line_resume">
    ...
    <div class="container">
      <div class="overflow">
        ...
        <v-card>
          <p>
            {{ userData.memberName }}님이 신청한 컨설팅 전문가 등록 목록은
            다음과 같습니다.
          </p>
          ...
          >
            <template v-slot:item="props">
              <tr class="end">
                ...
                <td
                  class="text-xs-right"
                  v-if="props.item.consultApproval === 'N'"
                  style="color:green"
                >
                  대기중
                </td>
                <td
                  class="text-xs-right"
                  v-if="props.item.consultApproval === 'R'"
                  style="color:red"
                >
                  신청거절
                </td>
                <td
                  class="text-xs-right"
                  v-if="props.item.consultApproval === 'Y'"
                  style="color:blue"
                >
                  신청승인
                </td>
...
export default {
  ...
  methods: {
    ...
    insertConsult() {
      ...
      axios
        .post(
          "http://rclass.iptime.org:9999/20AM_ITJOBGO_BOOT_FINAL/itjobgo/resume/insertconsult.do",
          formData,
          {
            headers: {
