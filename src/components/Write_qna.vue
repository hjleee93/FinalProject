...
<div class="container">
  <div>
			<h2 class="st_title">게시글 작성하기</h2><hr>
    ...
    <b-form @submit="onSubmit" @reset="onReset" v-if="show">
      ...
      <div class="btn_sr">
      <b-button type="submit" id="btn_write" variant="primary" class="btn-space">등록하기</b-button>
      <b-button type="reset" id="btn_write" variant="primary" class="btn-space" onclick="history.back(-1);">목록으로</b-button>
      </div>
    </b-form>
